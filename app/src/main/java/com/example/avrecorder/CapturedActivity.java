    ...
    public void qqqqq() {
        mHandler.postDelayed(() -> {
            ...
            if (boundsToCheck.width() < 90 || boundsToCheck.height() < 90) {
                Log.d(TAG,"capture bounds too small to be a fullscreen activity: " + boundsToCheck);
            }
/*
            ...
            mVirtualDisplay = mMediaProjection.createVirtualDisplay("CtsCapturedActivity",
                    ...
                    /*                   mSurfacePixelValidator.getSurface(),*/mSurface,
                    null /*Callbacks*/,
                    null /*Handler*/);
...
/*                   mSurfacePixelValidator.getSurface(),*/null,
                    null /*Callbacks*/,
                    null /*Handler*/);
        }, START_CAPTURE_DELAY_MS);
...
/*
    public void verifyTest(*//*ISurfaceValidatorTestCase testCase, TestName name*//*) throws Throwable {
        CapturedActivity.TestResult result = runTest();
