...
public class MainActivity4 extends AppCompatActivity {
        ...
        mToggleButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(MainActivity4.this,
                        ...
                        .checkSelfPermission(MainActivity4.this,
                                Manifest.permission.RECORD_AUDIO)
                        != PackageManager.PERMISSION_GRANTED) {
                    if (ActivityCompat.shouldShowRequestPermissionRationale
                            (MainActivity4.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) ||
                            ActivityCompat.shouldShowRequestPermissionRationale
                                    (MainActivity4.this, Manifest.permission.RECORD_AUDIO)) {
    ...
    public void onToggleScreenShare(View view) {
        if (((ToggleButton) view).isChecked()) {
            if (mMediaProjection == null) {
                Intent tIntent = mProjectionManager.createScreenCaptureIntent();
                Log.d(TAG,"toggle intent "+tIntent);
                startActivityForResult(tIntent, REQUEST_CODE);
            } else {
                startRecording();
            }
        } else {
